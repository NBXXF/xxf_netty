...
/*    public int sendCommonData(String dataContentWidthStr, String to_user_id) {
    ...
    public int sendCommonData(String dataContentWidthStr, String to_user_id, boolean QoS, String fingerPrint, int typeu,
        ...
        return sendCommonData(ProtocalFactory.createCommonData(dataContentWidthStr
                , ClientCoreSDK.getInstance().getCurrentLoginUserId(), fromNickname, fromAvatar, to_user_id, QoS, fingerPrint, typeu, timestamp));
    }
...
/*
        ...
        public SendCommonDataAsync(String dataContentWidthStr, String to_user_id, String fingerPrint, int typeu, String fromNickname,
                                   String fromAvatar,
                                   long timestamp) {
            this(ProtocalFactory.createCommonData(dataContentWidthStr
                    , ClientCoreSDK.getInstance().getCurrentLoginUserId(), fromNickname, fromAvatar, to_user_id, true, fingerPrint, typeu, timestamp));
        }
