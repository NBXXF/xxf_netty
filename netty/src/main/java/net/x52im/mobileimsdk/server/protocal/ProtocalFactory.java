...
public class ProtocalFactory {
    ...
    public static Protocal createCommonData(String dataContent,
                                            ...
                                            String fingerPrint,
                                            long timestamp) {
        return createCommonData(dataContent, from_user_id, fromNickname, fromAvatar, to_user_id, QoS, fingerPrint, -1, timestamp);
    }
    ...
    public static Protocal createCommonData(String dataContent,
        ...
        return new Protocal(ProtocalType.C.FROM_CLIENT_TYPE_OF_COMMON$DATA
                , dataContent, from_user_id, to_user_id, QoS, fingerPrint, typeu, fromNickname, fromAvatar, timestamp);
    }
